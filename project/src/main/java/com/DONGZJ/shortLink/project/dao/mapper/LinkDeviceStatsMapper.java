...
import com.DONGZJ.shortLink.project.dao.entity.LinkDeviceStatsDO;
...
public interface LinkDeviceStatsMapper extends BaseMapper<LinkDeviceStatsDO> {
     ...
     * 记录访问设备监控数据
     */
    @Insert("INSERT INTO t_link_device_stats (full_short_url, gid, date, cnt, device, del_flag) " +
            "VALUES( #{linkDeviceStats.fullShortUrl}, #{linkDeviceStats.gid}, #{linkDeviceStats.date}, #{linkDeviceStats.cnt}, #{linkDeviceStats.device}, 0) " +
