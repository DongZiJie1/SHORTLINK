...
import com.DONGZJ.shortLink.project.dao.entity.LinkBrowserStatsDO;
...
public interface LinkBrowserStatsMapper extends BaseMapper<LinkBrowserStatsDO> {
     ...
     * 记录浏览器访问监控数据
     */
    @Insert("INSERT INTO t_link_browser_stats (full_short_url, gid, date, cnt, browser, del_flag) " +
            "VALUES( #{linkBrowserStats.fullShortUrl}, #{linkBrowserStats.gid}, #{linkBrowserStats.date}, #{linkBrowserStats.cnt}, #{linkBrowserStats.browser},0) " +
